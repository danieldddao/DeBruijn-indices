 ...
 *    Each node has one reference to an E Object, stored in the instance variable data.
...
public class Tree<E>
{
   ...
   public Tree(E initialData, Tree<E> initialLeft, Tree<E> initialRight)
   {
      data = initialData;
      left = initialLeft;
      right = initialRight;
   ...
   **/ 
   public static <E> long treeSize(Tree<E> root)
   {
     ...
     **/
    public static Tree<String> buildTreeFromLeft (List<Tree<String>> list) {
     ...
     *   the tree built based on the list of small sub-tree.
     **/
    public static Tree<String> buildTreeFromRight (List<Tree<String>> list) {
        Tree<String> tree = null;
        try {
            if (list.size() == 1) {
                tree = list.remove(0);
